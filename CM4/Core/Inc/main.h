...
#define STSPIN_STBY_Pin GPIO_PIN_13
#define STSPIN_STBY_GPIO_Port GPIOB
...
#define MOT_POW_EN_Pin GPIO_PIN_11
#define MOT_POW_EN_GPIO_Port GPIOD
...
#define M1_PWM_EN_U_GPIO_Port GPIOH
