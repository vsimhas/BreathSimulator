...
#define  TICK_INT_PRIORITY            (0UL)  /*!< tick interrupt priority: TIM1 timebase
                                                  must preempt FreeRTOS-masked regions so
                                                  HAL_Delay()/timeouts always advance. The
                                                  TIM1_UP ISR only calls HAL_IncTick() and
                                                  makes no FreeRTOS API calls, so a priority
