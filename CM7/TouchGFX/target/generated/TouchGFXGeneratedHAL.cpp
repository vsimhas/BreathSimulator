...
namespace
{
static uint16_t* const frameBuf = reinterpret_cast<uint16_t*>(LCD_FRAME_BUFFER_ADDR);
...
void TouchGFXGeneratedHAL::initialize()
{
    ...
    /* Match the physical 480x272 panel - the generator's default 480, 271
     * left a one-pixel bottom row that TouchGFX never paints. */
